...
export default function Home() {
  return (
    <>
      ...
      <section className="page-hero" style={{ padding: '80px 0', textAlign: 'center' }}>
        <div className="wrap">
          <span className="eyebrow">WIRELESS COMMUNICATIONS</span>
          <h1 style={{ margin: '16px 0 24px' }}>Reliable two-way radio &amp; wireless networks for rural Alberta</h1>
      ...
      <section style={{ padding: '80px 0', backgroundColor: 'var(--paper-dim)' }}>
        <div className="wrap">
          <h2 style={{ textAlign: 'center', marginBottom: '60px' }}>What We Offer</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Two-Way Radio Systems</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Equipment Rentals</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Licensing &amp; Support</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Wireless Networking</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Tower Systems</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '4px', border: '1px solid var(--line-light)' }}>
              <h3 style={{ marginBottom: '16px' }}>Installation Services</h3>
      ...
      <section style={{ padding: '80px 0', backgroundColor: 'var(--paper-dim)' }}>
        <div className="wrap">
          <h2 style={{ textAlign: 'center', marginBottom: '60px' }}>Why Choose Keltech</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
            <div>
              <h3 style={{ fontSize: '18px', marginBottom: '12px' }}>Local Expertise</h3>
      ...
      <section style={{ padding: '80px 0', textAlign: 'center' }}>
        <div className="wrap">
          <h2 style={{ marginBottom: '20px' }}>Ready to discuss your communications needs?</h2>
